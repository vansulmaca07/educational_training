...
.status.bootstrap-select .dropdown-toggle::after {
    display:none;
                        ...
                        <tbody>
                            <tr style="width:100%">
                                <td style="width:20%">
                                    ...
                                    <select class="selectpicker form-control" data-size = "6" data-live-search = "true" multiple id="input-group-select" data-actions-box="true" aria-label="size 3 select example">
                                        <?php
                    ...
                    <div class="progress-t-container" style="height:75%;">
                        <table id="progressTable" class="table table-hover table-sm table-bordered rounded-3 overflow-visible progressT" style="height:100%; table-layout:fixed;">
                            <thead >
                                <tr id="firstrow" style="width:100%">
                                    <!--term-->
                                    <th style="width:5%; vertical-align:middle;">期
                                        <a href="" role="button" id="drowdownMenuLink"  data-bs-toggle="dropdown" aria-expanded="false" style="color:white"><i id="term_icon" style="float:right;" class="bi bi-caret-down"></i></a>
                                            <ul class="dropdown-menu">
                                                <?php
                                                    ...
                                                    <div class="list-group-item">
                                                        <label><input name="checkbox_term[]" type="checkbox" class="common_selector term" value="
                                                            <?php echo $row_term["term"];
                                                            ?>
                                                                "
                                                                <?php
                                        ...
                                        <th style="width:8%; vertical-align:middle;">No
                                            <a href="" role="button" id="" data-bs-toggle="dropdown" aria-expanded="false" style="color:white" ><i id="training_id_icon" style="float:right;" class="bi bi-caret-down"></i></a>
                                        ...
                                        <th style="width:40%; vertical-align:middle;">ファイル名
                                            <a href="" role="button" id="drowdownMenuLink" data-bs-toggle="dropdown" aria-expanded="false" style="color:white;"><i id="training_name_icon" style="float:right;" class="bi bi-caret-down"></i></a>
                                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                    <div class="list-group-item">
                                        ...
                                        <th style="width:10%; vertical-align:middle;">区分
                                            <a href="" role="button" id="drowdownMenuLink" data-bs-toggle="dropdown" aria-expanded="false" style="color:white"><i id="category_icon" style="float:right;" class="bi bi-caret-down"></i></a>
                                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                    <?php
                                                    ...
                                                    ?>
                                                        <div class="list-group-item checkbox">
                                                            <label><input name="checkbox_category[]" type="checkbox" class="common_selector category" value="
                                        ...
                                        <th style="width:19%; vertical-align:middle;">全体状態
                                            <a href=""  role="button" id="drowdownMenuLink" data-bs-toggle="dropdown" aria-expanded="false" style="color:white;"><i id="status_icon" style="float:right;" class="bi bi-caret-down"></i></a>
                                                <ul class="dropdown-menu">
                                                    <?php
                                                    ...
                                                    ?>
                                                        <div class="list-group-item checkbox">
                                                            <label><input name="checkbox_status[]" type="checkbox" class="common_selector status" value="
                                                ...
                                                <!----TEST
                                                <div class="status-container" style="width:80%;">
                                                    <select data-selected-text-format="static" title="全体状態" class="status selectpicker form-control" data-size = "6" data-live-search = "true" 
                                                    style="width: 15%;"
                                                    multiple id="input-group-select" data-actions-box="true" aria-label="size 3 select example">
                                                    <?php
                                                        $query_group = "SELECT * FROM group_
                                                        ORDER by group_name
                                                        ";
                                                        ...
                                                        foreach($result_status as $row_status)
                                                                {
                                                                    echo "<option name='checkbox_status[]' class='common_selector status' value='$row_status[status_id]' common_selector status>$row_status[status_name]</option>";
                                                                }
                                        ...
                                        <th style="width:13%; vertical-align:middle; text-align:center;">サイン進捗</th>
                                </tr>
                            </thead>
                            <tbody id="post_list2">
                            </tbody>
...
$('.common_selector').click(function(){
    ...
    if($('input[name="checkbox_status[]"]:checked').length > 0) {
