<?php
    ...
    switch(true) {
        ...
        case($_SESSION["userlevel"] === "4"):
            //continue
            break;
        case($creation_department !== $department):
...
/**shift icon **/
.add-shift.bootstrap-select .dropdown-menu { 
    width: 220px !important; 
    overflow: visible;
}

.add-shift.bootstrap-select .dropdown-toggle /*dropdown,*/
/*.bootstrap-select .dropdown-menu li a options*/
...
.none-add-shift.bootstrap-select .dropdown-toggle::after {
  border: none;
  font: normal normal normal 14px/1;
  font-style: bold;
  font-family: "bootstrap-icons";
...
.selected-add-shift.bootstrap-select .dropdown-toggle::after {
  border: none;
  font: normal normal normal 14px/1;
  font-style: bold;
  font-family: "bootstrap-icons";
...
.add-building.bootstrap-select .dropdown-menu { 
    width: auto !important; 
}

.add-building.bootstrap-select .dropdown-toggle /*dropdown,*/
/*.bootstrap-select .dropdown-menu li a options*/
...
.none-add-building.bootstrap-select .dropdown-toggle::after {
  border: none;
  font: normal normal normal 14px/1;
  font-style: bold;
  font-family: "bootstrap-icons";
...
.selected-add-building.bootstrap-select .dropdown-toggle::after {
  border: none;
  font: normal normal normal 14px/1;
  font-style: bold;
  font-family: "bootstrap-icons";
...
.add-process.bootstrap-select .dropdown-menu { 
    width: auto !important; 
...
.add-process.bootstrap-select .dropdown-toggle /*dropdown,*/
/*.bootstrap-select .dropdown-menu li a options*/
...
.none-add-process.bootstrap-select .dropdown-toggle::after {
  border: none;
  font: normal normal normal 14px/1;
  font-style: bold;
  font-family: "bootstrap-icons";
...
.selected-add-process.bootstrap-select .dropdown-toggle::after {
  border: none;
  font: normal normal normal 14px/1;
  font-style: bold;
  font-family: "bootstrap-icons";
...
.add-position.bootstrap-select .dropdown-menu { 
    width: auto !important; 
...
.add-position.bootstrap-select .dropdown-toggle /*dropdown,*/
/*.bootstrap-select .dropdown-menu li a options*/
...
.none-add-position.bootstrap-select .dropdown-toggle::after {
  border: none;
  font: normal normal normal 14px/1;
  font-style: bold;
  font-family: "bootstrap-icons";
...
.selected-add-position.bootstrap-select .dropdown-toggle::after {
  border: none;
  font: normal normal normal 14px/1;
  font-style: bold;
  font-family: "bootstrap-icons";
  ...
  vertical-align: 0; /* to center vertically */
        ...
        <div class="main w-100" id="main" style="height:87%;">           
            ...
            <div class="all-header w-100"  style="position:relative;  margin-bottom:15px;">
                <div class="new-form-header">
                    <button type="button" <?php echo $input_status; ?> id ="clear_button" class="btn btn-danger mb-3" style="font-size: 14px; float:left; width:100px; margin-right:20px; position:absolute;" onclick="">
                    内容クリア
                    </button>
                </div>
            ...
            <div id="participantsDIV" class="participantsDIV">
                <div class="header-participants row" style="">
                    <div class="filter-reset col-4 mb-3" style="float:left;">
                        <a class="btn btn-danger" id="reset-filter-btn" style="float:left;">リセット&nbsp;&nbsp;<i class="fa-solid fa-filter-circle-xmark"></i></a>
                    </div>
                    <div class="table-caption col-4">
                        <caption><b>受講者（製造）</b></caption> 
                    </div>
                    <div class="sign-page col-4 mb-3" style="">
                        <a href="includes/document_number.inc.php?training_id=<?php echo $training_id;?>" class="btn btn-primary" id="attendance-page-btn" style="float:right;">サインページ</a>
                    </div>
                </div>       
                    <table id="participantsTable" style="font-size: 14px;" class="table table-sm table-hover table-bordered overflow-visible rounded-3 participantsT">
                        <thead class="table text-center theadstyle participants_thead" style="width: 98.5%;">
                            <tr id="firstrow" style="height: 40px;">
                                ...
                                <th style="width:13.1%; vertical-align:middle; height:40px;">
                                    <div class="shift-process-container p-0" style="width:100%;">
                                        ...
                                        <?php
                                           ...
                                           foreach($result as $row)
                                                {
                                                    echo "<option name='checkbox_process_main[]' value='$row[department_name]' class='common_selector process'
                                ...
                                <th style="width:11%; vertical-align:middle; height:40px;">
                                    <div class="building-container p-0" style="width:100%;">
                                        ...
                                        <?php
                                            ...
                                            foreach($result as $row)
                                            {
                                                    echo "<option name='checkbox_building_main[]' value='$row[building_id]' class='common_selector building'
                                ...
                                <th style="width:8.8%; vertical-align:middle; height:40px;">
                                    <div class="building-container p-0" style="width:100%;">
                                        <select data-selected-text-format="static" title="サイン" class="sign-progress selectpicker form-control" data-size = "6" data-live-search = "true" style=""
                                            multiple id="input-sign-progress-select" data-actions-box="true" aria-label="size 3 select example">
                                        <?php
                                             $query = 
                                            ...
                                            foreach($result as $row)
                                                {
                                                    echo "<option name='checkbox_sign_progress[]' value='$row[sign_progress]' class='common_selector sign_progress'
            ...
            <div style="width:100%; height: 60px; <?php if($open_training === "1") { echo "display:none;";} ?>">
                    <button type="button" class="btn btn-primary mb-3" data-bs-toggle="modal" data-bs-target="#staticBackdrop" style="float:left; width:150px;" 
                    <?php echo $input_status; ?>>
                    受講者追加&nbsp;<i class="bi bi-person-fill-add"></i>
                    </button>

                    <button type="button" class="btn btn-primary mb-3" data-bs-toggle="modal" id="email-modal-btn" data-bs-target="#email-modal" style="float:right; width:150px;"
                    <?php echo $input_status; ?>>
            ...
            <div class="upload_div">
                <div class="mb-3">
                    ...
                    <?php echo $input_status;?> multiple>
                </div>
            </div> 
        ...
        <div class="row" style="height:13%; padding-top:20px;">
                ...
                <button type="submit" class = "btn btn-primary" style="vertical-align: middle; text-decoration:none; float: left;width: 150px;"
                <?php echo $input_status;
                ?>
                >
                ...
                <div class="col-2">
                    <button data-bs-toggle="modal" class="btn btn-danger" data-bs-target="#delete_confirmation_modal" style="width: 100px; float:right;" 
                    <?php echo $input_status;
                    ?>>訓練削除</button>
                </div>
            ...
            <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                <div class="modal-dialog modal-xl" style="height: 95%;">
                    ...
                    <div class="modal-body" style=" max-height: calc(100% - 120px); overflow-y: scroll;">
                        ...
                        <table id="add-participants-table" border="1" style="height: 250px !important;" class="table table-hover overflow-visible rounded-3 table-sm participantsT">
                            <thead class="table text-center theadstyle participants_thead" style="width: 98.5%;">
                                <tr id="firstrow" style="height: 40px;">
                                    ...
                                    <th style="width:15%; vertical-align:middle;height:40px;">
                                        <div class="dropdown p-0">
                                            <button class="btn btn-add-GID-search" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">GID<i class="bi bi-caret-down float-right" id="GID_search_icon" style="float: right;"></i></button>
                                                <ul class="dropdown-menu p-2" style="width: 300px;" aria-labelledby="dropdownMenuButton1">
                                    ...
                                    <th style="width:15%; vertical-align:middle;height:40px;">
                                        <div class="dropdown p-0">
                                            <button class="btn btn-add-name-search" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">名前<i class="bi bi-caret-down float-right" id="GID_name_icon" style="float: right;"></i></button>
                                            <ul class="dropdown-menu p-2" style="width: 300px;" aria-labelledby="dropdownMenuButton1">
                                    ...
                                    <th style="width:15%; vertical-align:middle;height:40px;">
                                        <div class="add-shift-select-container p-0" style="width:100%;">
                                            <select data-selected-text-format="static" title="班" class="add-shift selectpicker form-control overflow-visible" data-size = "6" data-live-search = "true" style=""
                                                multiple id="input-add-shift-select" data-actions-box="true" aria-label="size 3 select example">
                                            <?php
                                                ...
                                                foreach($result as $row)
                                                    {
                                                        echo "<option name='checkbox_shift[]' value='$row[shift_description]' class='common_selector_add shift_add'
                                                        >$row[shift_description]</option>
                                                        ";    
                                                    }
                                            ?>
                                    ...
                                    <th style="width:15%; vertical-align:middle;height:40px;">
                                        <div class="add-position-select-container p-0" style="width:100%;">
                                            <select data-selected-text-format="static" title="役職" class="add-position selectpicker form-control overflow-visible" data-size = "6" data-live-search = "true" style=""
                                                multiple id="input-add-position-select" data-actions-box="true" aria-label="size 3 select example">
                                            <?php
                                                $query = "SELECT distinct(position), users.position_id FROM users
                                                INNER JOIN 
                                                ...
                                                foreach($result as $row)
                                                    {
                                                        echo "<option name='checkbox_position[]' value='$row[position_id]' class='common_selector_add position_add'
                                                        >$row[position]</option>
                                                        ";    
                                                    }
                                            ?>
                                    ...
                                    <th style="width:15%; vertical-align:middle; height:40px;">
                                        <div class="add-process-container p-0" style="width:100%;">
                                            <select data-selected-text-format="static" title="工程" class="add-process selectpicker form-control" data-size = "6" data-live-search = "true" style=""
                                                multiple id="input-add-process-select" data-actions-box="true" aria-label="size 3 select example">
                                            <?php
                                                ...
                                                foreach($result as $row)
                                                    {
                                                        echo "<option name='checkbox_process[]' value='$row[department_name]' class='common_selector_add process_add'
                                    ...
                                    <th style="width:15%; vertical-align:middle; height:40px;">
                                        <div class="add-building-container p-0" style="width:100%;">
                                            <select data-selected-text-format="static" title="号棟" class="add-building selectpicker form-control" data-size = "6" data-live-search = "true" style=""
                                                multiple id="input-add-building-select" data-actions-box="true" aria-label="size 3 select example">
                                            <?php
                                                ...
                                                foreach($result as $row)
                                                {
                                                        echo "<option name='checkbox_building[]' value='$row[building_id]' class='common_selector_add building_add'
                                                        >$row[building_name]</option>
                                                        ";    
                                                    }
                                            ?>
   ...
   /* $("#select_all").on('change', function(event){
    ...
    function change_icon () {
        ...
        if($('#input-sign-progress-select :selected').length > 0) {
            $('.sign-progress').removeClass("none-sign-progess").addClass("selected-sign-progress");
        }
        else {
            $('.sign-progress').removeClass("selected-sign-progress").addClass("none-sign-progress"); 
        }

        if($('#input-add-shift-select :selected').length > 0) {
            $('.add-shift').removeClass("none-add-shift").addClass("selected-add-shift");
        }
        else {
            $('.add-shift').removeClass("selected-add-shift").addClass("none-add-shift"); 
        }
        if($('#input-add-building-select :selected').length > 0) {
            $('.add-building').removeClass("none-add-building").addClass("selected-add-building");
        }
        else {
            $('.add-building').removeClass("selected-add-building").addClass("none-add-building"); 
        }
        if($('#input-add-process-select :selected').length > 0) {
            $('.add-process').removeClass("none-add-process").addClass("selected-add-process");
        }
        else {
            $('.add-process').removeClass("selected-add-process").addClass("none-add-process"); 
        }
        if($('#input-add-position-select :selected').length > 0) {
            $('.add-position').removeClass("none-add-position").addClass("selected-add-position");
        }
        else {
            $('.add-position').removeClass("selected-add-position").addClass("none-add-position"); 
        }
    ...
    //Add Participants
    $('#input-add-shift-select').change(function() {
        change_icon();
        filter_add_data();
    });
    $('#input-add-building-select').change(function() {
        change_icon();
        filter_add_data();
    });
    $('#input-add-process-select').change(function() {
        change_icon();
        filter_add_data();
    });
    $('#input-add-position-select').change(function() {
        change_icon();
        filter_add_data();
    });
    ...
    $("#add-participants-reset-filter-btn").on("click", function() {
        $("#input-add-shift-select").val("").trigger("change");
        $("#input-add-shift-select").selectpicker("val","");
        $("#input-add-building-select").val("").trigger("change");
        $("#input-add-building-select").selectpicker("val","");
        $("#input-add-position-select").val("").trigger("change");
        $("#input-add-position-select").selectpicker("val","");
       // $("#input-add-process-select").val("").trigger("change");
       // $("#input-add-process-select").selectpicker("val","");
        ...
        var process_selection = $("#input-add-process-select option[name='checkbox_process[]']");

        $.each(process_selection, function () {
            
            var this_process = $(this).val();

            if(this_process === main_department) {
        ...
        $("#input-add-process-select").selectpicker("refresh");
    ...
    $('#GID_search_main').on("input",function(){
    ...
    $('#GID_name_main').on("input",function(){
    ...
    function filter_add_data() {
      ...
      var position_add = get_filter('position_add');
      ...
      $.ajax({
          url: "includes/fetch_data_add_participants.inc.php",
          method: "POST",
          data: {action:action,shift_add:shift_add,position_add:position_add,process_add:process_add,building_add:building_add,GID_search:GID_search,GID_name:GID_name},
          success:function(data){
...
$("#update-form").on("submit", function() {
    ...
    //Check Term, should be 3 digits in half width
